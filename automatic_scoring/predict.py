...
from utils.defisheye import generate_defisheye_frames #NOTE: import generate_defisheye_frames to defisheye frames
...
if __name__ == '__main__':
    ...
    parser.add_argument('--defisheye', action='store_true', default=False, help='whether to defisheye the video') #NOTE: add defisheye argument
    ...
    generate_frames = generate_defisheye_frames if args.defisheye else generate_frames #NOTE: decide whether to defisheye the video by args.defisheye
    ...
    if args.eval_mode == 'nonoverlap':
        ...
        dataset = Shuttlecock_Trajectory_Dataset(seq_len=seq_len, sliding_step=1, data_mode='heatmap', bg_mode=bg_mode,     #FIXME: bottleneck for real time prediction
    ...
    if args.output_video:
        write_pred_video(frame_list, dict(fps=fps, shape=(w, h)), pred_dict, save_file=out_video_file, traj_len=args.traj_len, fps=fps)
